...
<html lang="en">
  <head>
    <title>Main Video Album Data Add</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
            ...
            <div class="container mt-4 card p-3 bg-white">
                ...
                <div class="row">
                    <div class="form-group col-md-3 required">
                        ...
                        @if ($tital == "Add Data")
                        <input type="text" name="mV_title" id="" class="form-control" value=""/>
                        @else
                        <input type="text" name="mV_title" id="" class="form-control" value="{{ $mvalbum->mV_title }}"/>
                        @endif
                    ...
                    <div class="form-group col-md-6 required">
                        ...
                        @if ($tital == "Add Data")
                        <input type="text" name="mV_link" id="" class="form-control" value=""/>
                        @else
                        <input type="text" name="mV_link" id="" class="form-control" value="{{ $mvalbum->mV_link }}"/>
                        @endif
                    </div>
                </div>
